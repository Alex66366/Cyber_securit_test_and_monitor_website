...
class FlowSession(DefaultSession):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # if self.output_mode == "flow":
            ...
            # self.csv_writer = csv.writer(output) #创建csv.writer对象
    ...
    def garbage_collect(self, latest_time) -> None:
        ...
        for k in keys:
            ...
            if (
                ...
                if self.data_line == 0: #最上面那行
                    # self.csv_writer.writerow(data.keys())
                    global column_key
                    column_key = data.keys()
                ...
                del self.flows[k]
        global final_data_set
        final_data_set = pd.DataFrame(data_set,columns=column_key)
        if not self.url_model:
